...
namespace StaffManage.Controllers
{
    ...
    [ApiController]
    public class ChiTietDeTaiDuAnKHCNThamGiasController : ControllerBase
    {
        private readonly StaffDbContext _context;
        private readonly IMapper _mapper;

        public ChiTietDeTaiDuAnKHCNThamGiasController(StaffDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<ActionResult<ChiTietDeTaiDuAnKHCNThamGiaModel>> GetChiTietDeTaiDuAnKHCNThamGia(int madetai, string macanbo)
        {
          if (_context.chiTietDeTaiDuAnKHCNThamGia == null)
          {
              return NotFound();
        ...
        public async Task<IActionResult> PutChiTietDeTaiDuAnKHCNThamGia(int madetai, string macanbo, ChiTietDeTaiDuAnKHCNThamGiaModel chiTietDeTaiDuAnKHCNThamGia)
        {
        ...
        public async Task<IActionResult> DeleteChiTietDeTaiDuAnKHCNThamGia(int madetai, string macanbo)
        {
            if (_context.chiTietDeTaiDuAnKHCNThamGia == null)
            {
                return NotFound();
        ...
        private bool ChiTietDeTaiDuAnKHCNThamGiaExists(int madetai, string macanbo)
        {
