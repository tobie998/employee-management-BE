...
namespace StaffManage.Controllers
{
    ...
    [ApiController]
    public class ChiTietQuaTrinhCongTacsController : ControllerBase
    {
        private readonly StaffDbContext _context;
        private readonly IMapper _mapper;

        public ChiTietQuaTrinhCongTacsController(StaffDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<ActionResult<ChiTietQuaTrinhCongTacModel>> GetChiTietQuaTrinhCongTac(int maquatrinhcongtac, string macanbo)
        {
          if (_context.chiTietQuaTrinhCongTac == null)
          {
              return NotFound();
        ...
        public async Task<IActionResult> DeleteChiTietQuaTrinhCongTac(int maquatrinhcongtac, string macanbo)
        {
            if (_context.chiTietQuaTrinhCongTac == null)
            {
                return NotFound();
        ...
        private bool ChiTietQuaTrinhCongTacExists(int maquatrinhcongtac, string macanbo)
        {
