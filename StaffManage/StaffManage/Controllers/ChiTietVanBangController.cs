...
namespace StaffManage.Controllers
{
    ...
    public class ChiTietVanBangController : ControllerBase
    {
        ...
        public async Task<ActionResult<ChiTietVanBangModel>> GetChiTietVanBang(int mavanbang, string macanbo)
        {
          if (_context.chiTietVanBang == null)
          {
              return NotFound();
        ...
        public async Task<IActionResult> PutChiTietVanBang(int mavanbang, string macanbo, ChiTietVanBangModel chiTietVanBang)
        {
        ...
        public async Task<IActionResult> DeleteChiTietVanBang(int mavanbang, string macanbo)
        {
            if (_context.chiTietVanBang == null)
            {
                return NotFound();
        ...
        private bool ChiTietVanBangExists(int mavanbang, string macanbo)
        {
