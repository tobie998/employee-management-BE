...
namespace StaffManage.Data
{
    public class StaffDbContext : DbContext
    {
        ...
        public DbSet<ChiTietChuyenNganhKH_CN> chiTietChuyenNganhKH_CN { get; set; }
        public DbSet<ChuyenNganhKH_CN> chuyenNganhKH_CN { get; set; }
        ...
        public DbSet<DeTaiDuAnKHCNChuTri> chiTietDeTaiDuAnKH_CN { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ChiTietChuyenNganhKH_CN>(entity =>
            {
                entity.HasKey(c => new { c.Machuyennganh, c.Macanbo });

                entity.HasOne(e => e.chuyenNganhKH_CN).WithMany(e => e.chiTietChuyenNganhKH_CN)
                .HasForeignKey(e => e.Machuyennganh);

                entity.HasOne(e => e.CanBo).WithMany(e => e.chiTietChuyenNganhKH_CN)
                .HasForeignKey(e => e.Macanbo);
            ...
            modelBuilder.Entity<ChuyenNganhKH_CN>(entity =>
            {
                entity.HasKey(c =>  c.Machuyennganh);

                entity.HasOne(e => e.LinhVucNghienCuu).WithMany(e => e.chuyenNganhKH_CNs)
                .HasForeignKey(e => e.Malinhvuc);
