...
namespace StaffManage.Controllers
{
    ...
    [ApiController]
    public class ChiTietKhenThuongController : ControllerBase
    {
        private readonly StaffDbContext _context;
        private readonly IMapper _mapper;

        public ChiTietKhenThuongController(StaffDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<ActionResult<ChiTietKhenThuongModel>> GetChiTietKhenThuong(string makhenthuong, string macanbo)
        {
          if (_context.chiTietKhenThuong == null)
          {
              return NotFound();
        ...
        public async Task<IActionResult> PutChiTietKhenThuong(string makhenthuong, string macanbo, ChiTietKhenThuongModel chiTietKhenThuong)
        {
        ...
        public async Task<IActionResult> DeleteChiTietKhenThuong(string makhenthuong, string macanbo)
        {
            if (_context.chiTietKhenThuong == null)
            {
                return NotFound();
        ...
        private bool ChiTietKhenThuongExists(string makhenthuong, string macanbo)
        {
