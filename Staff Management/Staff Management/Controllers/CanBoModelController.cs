...
namespace StaffManage.Controllers
{
    ...
    [ApiController]
    public class CanBoModelController : ControllerBase
    {
        private readonly StaffDbContext _context;
        private readonly IMapper _mapper;
        private readonly ICommandDataClient _repo;

        public CanBoModelController(StaffDbContext context, IMapper mapper, ICommandDataClient repo)
        {
            _context = context;
            _mapper = mapper;
            _repo = repo;
        ...
        public async Task<IActionResult> PutCanBoModel(string id, CanBoModel canBoModel)
        {
            ...
            try
            {
                ...
                await _repo.SendStaffToLearning(canBo);
        ...
        public async Task<IActionResult> DeleteCanBoModel(string id)
        {
            ...
            //await _repo.SendStaffToResearcher(canBoNghienCuu);
            var canbodelete = await _context.canBo.SingleOrDefaultAsync(cb => cb.Macanbo == id);
            await _repo.SendStaffToLearning(canbodelete);
