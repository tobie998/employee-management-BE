...
namespace StaffManage.Controllers
{
    ...
    public class VanBangCanBoController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<VanBangCanBoModel>> GetVanBangCanBo(string id)
        {
          if (_context.vanBang == null)
          {
              return NotFound();
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutVanBangCanBo(string id, VanBangCanBoModel vanBangCanBo)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteVanBangCanBo(string id)
        {
            if (_context.vanBang == null)
            {
                return NotFound();
        ...
        private bool VanBangCanBoExists(string id)
        {
