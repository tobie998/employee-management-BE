...
namespace StaffManage.Controllers
{
    ...
    public class ChiTietCongTrinhKH_CNController : ControllerBase
    {
        ...
        public async Task<ActionResult<ChiTietCongTrinhKH_CNModel>> GetChiTietCongTrinhKH_CN(string macongtrinhKH, string macanbo)
        {
          if (_context.chiTietCongTrinhKH_CN == null)
          {
              return NotFound();
        ...
        public async Task<IActionResult> PutChiTietCongTrinhKH_CN(string macongtrinhKH, string macanbo, ChiTietCongTrinhKH_CNModel chiTietCongTrinhKH_CN)
        {
        ...
        public async Task<IActionResult> DeleteChiTietCongTrinhKH_CN(string macongtrinhKH, string macanbo)
        {
            if (_context.chiTietCongTrinhKH_CN == null)
            {
                return NotFound();
        ...
        private bool ChiTietCongTrinhKH_CNExists(string macongtrinhKH, string macanbo)
        {
