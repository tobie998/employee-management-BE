...
namespace StaffManage.Controllers
{
    ...
    public class QuaTrinhDaoTaoController : ControllerBase
    {
        ...
        public QuaTrinhDaoTaoController(StaffDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<QuaTrinhDaoTaoModel>> GetQuaTrinhDaoTao(string id)
        {
          if (_context.quaTrinhDaoTao == null)
          {
              return NotFound();
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutQuaTrinhDaoTao(string id, QuaTrinhDaoTaoModel quaTrinhDaoTao)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteQuaTrinhDaoTao(string id)
        {
            if (_context.quaTrinhDaoTao == null)
            {
                return NotFound();
        ...
        private bool QuaTrinhDaoTaoExists(string id)
        {
