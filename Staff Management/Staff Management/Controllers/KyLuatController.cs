...
namespace StaffManage.Controllers
{
    ...
    public class KyLuatController : ControllerBase
    {
        ...
        public KyLuatController(StaffDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        // GET: api/KyLuats/5
        [HttpGet("{id}")]
        public async Task<ActionResult<KyLuatModel>> GetKyLuat(string id)
        {
          if (_context.kyLuat == null)
          {
              return NotFound();
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutKyLuat(string id, KyLuatModel kyLuat)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteKyLuat(string id)
        {
            if (_context.kyLuat == null)
            {
                return NotFound();
