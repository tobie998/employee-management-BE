...
namespace StaffManage.Controllers
{
    ...
    [ApiController]
    public class ChiTietGiaiThuongController : ControllerBase
    {
        private readonly StaffDbContext _context;
        private readonly IMapper _mapper;

        public ChiTietGiaiThuongController(StaffDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<ActionResult<ChiTietGiaiThuongModel>> GetChiTietGiaiThuong(string magiaithuong, string macanbo)
        {
          if (_context.chiTietGiaiThuong == null)
          {
              return NotFound();
        ...
        public async Task<IActionResult> PutChiTietGiaiThuong(string magiaithuong, string macanbo, ChiTietGiaiThuongModel chiTietGiaiThuong)
        {
        ...
        public async Task<IActionResult> DeleteChiTietGiaiThuong(string magiaithuong, string macanbo)
        {
            if (_context.chiTietGiaiThuong == null)
            {
                return NotFound();
        ...
        private bool ChiTietGiaiThuongExists(string magiaithuong, string macanbo)
        {
