...
namespace StaffManage.Controllers
{
    ...
    public class NghienCuuSinhDaHuongDanController : ControllerBase
    {
        ...
        public async Task<ActionResult<NghienCuuSinhDaHuongDanModel>> GetNghienCuuSinhDaHuongDan(string maNCS, string macanbo)
        {
          if (_context.nghienCuuSinhDaHuongDan == null)
          {
              return NotFound();
        ...
        public async Task<IActionResult> PutNghienCuuSinhDaHuongDan(string maNCS, string macanbo, NghienCuuSinhDaHuongDanModel nghienCuuSinhDaHuongDan)
        {
        ...
        public async Task<IActionResult> DeleteNghienCuuSinhDaHuongDan(string maNCS, string macanbo)
        {
            if (_context.nghienCuuSinhDaHuongDan == null)
            {
                return NotFound();
        ...
        private bool NghienCuuSinhDaHuongDanExists(string maNCS, string macanbo)
        {
