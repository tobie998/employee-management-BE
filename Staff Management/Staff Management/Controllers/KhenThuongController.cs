...
namespace StaffManage.Controllers
{
    ...
    public class KhenThuongController : ControllerBase
    {
        ...
        public KhenThuongController(StaffDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<KhenThuongModel>> GetKhenThuong(string id)
        {
          if (_context.khenThuong == null)
          {
              return NotFound();
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutKhenThuong(string id, KhenThuongModel khenThuong)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteKhenThuong(string id)
        {
            if (_context.khenThuong == null)
            {
                return NotFound();
