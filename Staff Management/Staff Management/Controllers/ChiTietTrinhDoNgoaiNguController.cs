...
namespace StaffManage.Controllers
{
    ...
    [ApiController]
    public class ChiTietTrinhDoNgoaiNguController : ControllerBase
    {
        private readonly StaffDbContext _context;
        private readonly IMapper _mapper;


        public ChiTietTrinhDoNgoaiNguController(StaffDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<ActionResult<ChiTietTrinhDoNgoaiNguModel>> GetChiTietTrinhDoNgoaiNgu(string mangoaingu, string macanbo)
        {
          if (_context.chiTietTrinhDoNgoaiNgu == null)
          {
              return NotFound();
        ...
        public async Task<IActionResult> PutChiTietTrinhDoNgoaiNgu(string mangoaingu, string macanbo, ChiTietTrinhDoNgoaiNguModel chiTietTrinhDoNgoaiNgu)
        {
        ...
        public async Task<IActionResult> DeleteChiTietTrinhDoNgoaiNgu(string mangoaingu, string macanbo)
        {
            if (_context.chiTietTrinhDoNgoaiNgu == null)
            {
                return NotFound();
        ...
        private bool ChiTietTrinhDoNgoaiNguExists(string mangoaingu, string macanbo)
        {
