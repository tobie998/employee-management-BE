...
namespace StaffManage.Controllers
{
    ...
    [ApiController]
    public class ChiTietKyLuatController : ControllerBase
    {
        private readonly StaffDbContext _context;
        private readonly IMapper _mapper;

        public ChiTietKyLuatController(StaffDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<ActionResult<ChiTietKyLuatModel>> GetChiTietKyLuat(string makyluat, string macanbo)
        {
          if (_context.chiTietKyLuat == null)
          {
              return NotFound();
        ...
        public async Task<IActionResult> PutChiTietKyLuat(string makyluat, string macanbo, ChiTietKyLuat chiTietKyLuat)
        {
        ...
        public async Task<IActionResult> DeleteChiTietKyLuat(string makyluat, string macanbo)
        {
            if (_context.chiTietKyLuat == null)
            {
                return NotFound();
        ...
        private bool ChiTietKyLuatExists(string makyluat, string macanbo)
        {
