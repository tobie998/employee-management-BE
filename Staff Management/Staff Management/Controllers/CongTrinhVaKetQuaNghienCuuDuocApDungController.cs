...
namespace StaffManage.Controllers
{
    ...
    [ApiController]
    public class CongTrinhVaKetQuaNghienCuuDuocApDungController : ControllerBase
    {
        private readonly StaffDbContext _context;
        private readonly IMapper _mapper;

        public CongTrinhVaKetQuaNghienCuuDuocApDungController(StaffDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<ActionResult<CongTrinhVaKetQuaNghienCuuDuocApDungModel>> GetCongTrinhVaKetQuaNghienCuuDuocApDung(string macongtrinhnghiencuu, string macanbo)
        {
            if (_context.congTrinhVaKetQuaNghienCuuDuocApDung == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> PutCongTrinhVaKetQuaNghienCuuDuocApDung(string macongtrinhnghiencuu, string macanbo, CongTrinhVaKetQuaNghienCuuDuocApDungModel congTrinhVaKetQuaNghienCuuDuocApDung)
        {
        ...
        public async Task<IActionResult> DeleteCongTrinhVaKetQuaNghienCuuDuocApDung(string macongtrinhnghiencuu, string macanbo)
        {
            if (_context.congTrinhVaKetQuaNghienCuuDuocApDung == null)
            {
                return NotFound();
        ...
        private bool CongTrinhVaKetQuaNghienCuuDuocApDungExists(string macongtrinhnghiencuu, string macanbo)
        {
